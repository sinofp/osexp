...
int main(int argc, char* argv[]) {
    system("chcp 65001");  // to use utf-8 in shell
    ...
    if (!CreateProcess(NULL, argv[1], NULL, NULL, FALSE, 0, NULL, NULL, &si,
                       &pi)) {
    ...
    printf("%d小时%d分钟%d秒%d毫秒\n", end.wHour - start.wHour,
           end.wMinute - start.wMinute, end.wSecond - start.wSecond,
